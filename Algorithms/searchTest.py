...
def main():
    ...
    b = timeit.Timer('simSearch(\'binary\','+str(numrange)+','+str(searchSortList)+',0)',"from __main__ import simSearch")
    l = timeit.Timer('simSearch(\'linear\','+str(numrange)+','+str(searchSortList)+','+str(len(searchList))+')',"from __main__ import simSearch")
    ...
    print("{0:12}{1:>10}{2:>15}{3:>25}{4:>30}".format("Search Type","# Searches","List Size","Avg. Iterations", "Average Time"))
    print("-"*100)
